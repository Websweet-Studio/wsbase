...
add_filter( 'comment_form_default_fields', 'wsbase_bootstrap_comment_form_fields' );

if ( ! function_exists( 'wsbase_bootstrap_comment_form_fields' ) ) {
	/**
	 ...
	 * @return array
	 */
	function wsbase_bootstrap_comment_form_fields( $fields ) {
...
} // End of if function_exists( 'wsbase_bootstrap_comment_form_fields' )

// Add Bootstrap classes to comment form submit button and comment field.
add_filter( 'comment_form_defaults', 'wsbase_bootstrap_comment_form' );

if ( ! function_exists( 'wsbase_bootstrap_comment_form' ) ) {
	/**
	 ...
	 * @return string[]
	 */
	function wsbase_bootstrap_comment_form( $args ) {
		$replace = array(
			'<p class="' => '<div class="form-group mb-3 ',
...
} // End of if function_exists( 'wsbase_bootstrap_comment_form' ).


// Add note if comments are closed.
add_action( 'comment_form_comments_closed', 'wsbase_comment_form_comments_closed' );

if ( ! function_exists( 'wsbase_comment_form_comments_closed' ) ) {
	/**
	 * Displays a note that comments are closed if comments are closed and there are comments.
	 */
	function wsbase_comment_form_comments_closed() {
...
} // End of if function_exists( 'wsbase_comment_form_comments_closed' ).
